...
Did you know that Arizona has been in a drought for 27 years? That's nearly three decades of parched lands and dwindling water supplies, putting our beloved state's way of life at risk. Almost half of our water comes from the Colorado River, which also sustains farms, wildlife, and neighboring states.\
...
\
Our aim is to create easy-to-understand visuals that show what's happening and get people thinking about solutions. We'll look closely at how different areas are dealing with water shortages to figure out where to focus our efforts to help.\
...
The various components of the dashboard include:
...
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
| Week 6          | Data Exploration, Data Cleaning, Data preprocesing                                                                                   | Everyone                |
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
|                 | Assign induvidial tasks                                                                                                              |                         |
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
| Week 7          | Understanding the basics and start generating plots                                                                                  | Everyone                |
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
|                 | create three graphs:\                                                                                                                | TBD                     |
|                 | 1. donut-shaped graph that shows the average percentage of each drought level from 2000 to present.                                  |                         |
|                 |                                                                                                                                      |                         |
...
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
| Week 8          | Work on implementing the sliding bar by which a specific time frame can be chosen and the other three graphs will adjust accordingly | TBD                     |
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
| Week 9          | Create an interactive dashboard                                                                                                      | TBD                     |
+-----------------+--------------------------------------------------------------------------------------------------------------------------------------+-------------------------+
